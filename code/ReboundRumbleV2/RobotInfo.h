...
// PWM Channels.
//
#define PWM_CONVEYOR_MOTOR              1       //white (9)
#define PWM_ROLLER_MOTOR                2       //orange (7)
...
// Digital Channels.
//
#define DIN_CMP_PRESSURE_SWITCH         1       //3

//
// Relay Channels.
//

#define RELAY_COMPRESSOR                1       //green (6)
#define RELAY_RINGLIGHT_POWER           2       //yellow (1)
...
#define SOL_WHITE_LIGHT                 ((UINT32)8)
...
#ifdef _USE_DSENH_SWITCHES
#define DSSW_CONVEYOR_CTRL_ENABLED      DSCHN_SW1
#endif
