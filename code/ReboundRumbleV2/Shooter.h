...
public:
...
#ifndef _NO_SHOOTER_JAGS
        m_shooterPIDMotor.SetPIDEnabled(false);
#endif
    ...
    Shooter(
         ...
         , m_shooterPIDCtrl("Shooter",
                            SHOOTER_KP, SHOOTER_KI, SHOOTER_KD,
         ...
         , m_speedLight(SOL_GREEN_LIGHT, SOL_MODULE2)
        ...
        )
    {
        ...
        m_speedLight.Set(m_speedWithinTolerance);
        UpdateGuideLights();
