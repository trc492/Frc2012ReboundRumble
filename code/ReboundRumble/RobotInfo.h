...
#define CANID_SHOOTER1_JAG              6
#define CANID_SHOOTER2_JAG              7

//
// PWM Channels.
//
#define PWM_CONVEYOR_MOTOR              9
#define PWM_ROLLER_MOTOR                7
...
#define SOL_LEFT_LIGHT                  ((UINT32)3)
#define SOL_MIDDLE_LIGHT                ((UINT32)4)
#define SOL_RIGHT_LIGHT                 ((UINT32)5)

#define SOL_WHITE_LIGHT                 ((UINT32)6)
#define SOL_GREEN_LIGHT                 ((UINT32)8)

#define SOL_MODULE2                     ((UINT8)2)
#define SOL_BALLGATE_CLOSE              ((UINT32)1)
#define SOL_BALLGATE_OPEN               ((UINT32)2)
